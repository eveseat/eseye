...
class CheckAccess implements AccessInterface
{
    ...
    protected $scope_map = [
        'get'    =>
            [
                ...
                '/characters/{character_id}/wallets/'             => 'esi-wallet.read_character_wallet.v1',
    ...
    public function can(string $method, string $uri, array $scopes): bool
    {
        ...
        if (! array_key_exists($uri, $this->scope_map[$method])) {
            ...
            // TODO: Warn about the fact that an unknown URI was called!
            echo 'WARNING: An unknown URI was called. Allowing ' . $uri . PHP_EOL;
