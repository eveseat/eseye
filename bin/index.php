    ...
    echo <<<EOF
      ...
      <div class="row marketing">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="clientid" name="clientid" type="text" placeholder="Client ID" required="required" class="form-control input-md">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input id="secret" name="secret" type="password" placeholder="Secret" required="required" class="form-control input-md">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            ...
            <!-- done :D -->
                ...
                <option value="esi-location.read_location.v1" selected="selected">esi-location.read_location.v1</option>
